...
import {
  resetPassword,
  validateResetToken,
} from "../../servicesFetch/accountServicesFetch";
...
export default function ResetPassword() {
  ...
  function getForm() {
    ...
    const handleFormSubmit = (
      ...
      sendingTheData({ password, confirmPassword }, { setSubmitting });
    };

    function sendingTheData({ password, confirmPassword }, { setSubmitting }) {
