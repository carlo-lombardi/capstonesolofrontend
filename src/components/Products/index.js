...
import {
  ...
  ProductArrow,
  RestarurantStatus,
  IconTakeAway, IconDelivery, ProductPromo,
...
const Products = ({ heading, items }) => {
  const random = [{
    name:"Birria",
    description:"Juicy beef brisket tacos served with cheese and a delicious beef broth",
    itemType:"Taco",
    unitPrice:5,
  }, {
    name:"Tacos",
      ...
      <div className="menu-page">
        <div className="menu-container">
          ...
          <div className="flex-group marT-5">
            <p className="flex-1">7-8, Finnstown Shopping Centre, Lucan, Co. Dublin</p>
